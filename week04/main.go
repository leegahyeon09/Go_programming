...
func main() {
	...
	//var a int = 7  //declartaion & assign value

	//var a = 7 //declartaion & assign value
	...
	// koreanzombie := "정찬성"  //문법적으로 문제없지만 damel케이스를 사용하는 관례를 따르자
	koreanZombie := "정찬성"
	...
	fmt.Println(strings.Title("open source\tpromgramming\n\"go\"!"))
	//fmt.Println("OpenSource Promgramming~", "Go")
}
